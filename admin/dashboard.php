...
<body class="bg-gray-50 flex">
    ...
    <aside id="sidebar" class="sidebar bg-sidebar h-screen sticky top-0 flex flex-col shadow-2xl">
        ...
        <nav class="flex-1 p-4 overflow-y-auto">
            <div class="mb-6">
                <p class="text-gray-500 text-xs uppercase mb-3 px-4 sidebar-label">General</p>
                <a href="dashboard.php" class="sidebar-item active flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 mb-2">
                    <i class="fas fa-home w-5"></i>
                    <span class="sidebar-text">Dashboard</span>
                </a>
                <a href="penerbangan.php" class="sidebar-item flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 mb-2">
                ...
                <a href="pemesanan.php" class="sidebar-item flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 mb-2">
                    ...
                    <span class="sidebar-text ml-auto bg-red-500 text-white text-xs px-2 py-1 rounded-full"><?= $stats['total_pending'] ?></span>
                    <?php endif; ?>
                </a>
            ...
            <div class="mb-6">
                <p class="text-gray-500 text-xs uppercase mb-3 px-4 sidebar-label">Analytics</p>
                <a href="#revenue" class="sidebar-item flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 mb-2">
            ...
            <div>
                <p class="text-gray-500 text-xs uppercase mb-3 px-4 sidebar-label">Support</p>
