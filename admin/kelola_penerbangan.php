        ...
        <div class="p-8">
            ...
            <div class="bg-white rounded-xl shadow-md mb-6 p-2 flex gap-2">
                ...
                <button onclick="switchTab('arrived')" id="tab-arrived" class="tab-button flex-1 px-6 py-3 rounded-lg font-semibold transition-all relative">
                    <i class="fas fa-plane-arrival mr-2"></i>Pesawat Tiba
            ...
            <!-- Tab Content: Pesawat Tiba -->
            <div id="content-arrived" class="tab-content hidden">
                <div class="bg-white rounded-xl shadow-md p-6 mb-6">
                    <h2 class="text-xl font-bold text-gray-800">Pesawat yang Sudah Tiba</h2>
                    <p class="text-gray-500 text-sm">Atur jadwal penerbangan berikutnya untuk pesawat yang telah sampai tujuan</p>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gradient-to-r from-green-500 to-green-600 text-white">
                                <tr>
                                    <th class="px-6 py-4 text-left">Kode Penerbangan</th>
                                    <th class="px-6 py-4 text-left">Pesawat</th>
                                    <th class="px-6 py-4 text-left">Lokasi Saat Ini</th>
                                    <th class="px-6 py-4 text-left">Waktu Tiba</th>
                                    <th class="px-6 py-4 text-center">Status</th>
                                    <th class="px-6 py-4 text-center">Aksi</th>
                                </tr>
                            </thead>
