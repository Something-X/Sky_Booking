<?php
// Load config.php from project root (robust when run via web or CLI)
$configPath = __DIR__ . '/../config.php';
if (!file_exists($configPath)) {
    die("\n    <div style='font-family: Arial; padding: 20px; background: #fee; border: 2px solid red; margin: 20px;'>\n        <h2 style='color: red;'>❌ ERROR: config.php not found!</h2>\n        <p>Expected location: <code>$configPath</code></p>\n    </div>\n    ");
}
